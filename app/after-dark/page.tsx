  ...
  return (
    <main className="dark-shell">
      ...
      <section className="dark-hero" id="top">
        <header className="dark-nav"><Link href="#top" className="brand-image" aria-label="Lucky 7's Lounge home"><span>Lucky 7’s Lounge</span></Link><nav><Link href="#play">Play</Link><Link href="#pour">Eat & drink</Link><Link href="#events">Events</Link></nav><Link className="dark-pill" href="#visit">Somonauk, IL <i /></Link></header>
